pipeline {
    ...
    stages {
      stage('CheckOut GitHub Repo') {
          steps {
              checkout([$class: 'GitSCM', branches: [[name: 'master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'GitHubAccess', url: 'https://github.com/Kiran2361993/git-packer-terraform-AMI.git']]])
            }
        }
